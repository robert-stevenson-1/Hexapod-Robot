...
#define BODY_THICKNESS 65

#define BODY_CENTER_OFFSET_X 75.5
#define BODY_CENTER_OFFSET_Z 55 
#define D1 sqrt(powf(BODY_CENTER_OFFSET_X, 2) + powf(BODY_CENTER_OFFSET_Z, 2))
#define D2 (OFFSET_LENGTH + FEMUR_LENGTH)
#define S (D1/(OFFSET_LENGTH + FEMUR_LENGTH))
#define THETA atan(BODY_CENTER_OFFSET_X/BODY_CENTER_OFFSET_Z)
